...
def Encaminhar_primeira_menssagem(grupo):
    ...
    pyautogui.click(1016,789,duration=1)
    sleep(2)
...
def Encaminhar_outras_menssagem(grupo):
    # Mandando Menssagem pro Segundo Grupo
...
for index, grupo in enumerate(Lista_grupos):
    ...
    #Printa na Tela
    print(f'Enviado com sucesso para o {grupo}!')
...
# 1 - Clicar Para encaminhar menssagem (Cordenadas: 1016,789)
#pyautogui.click(1016,789,duration=1)
#sleep(2)
# 2 - Digitar nome do Grupo
...
#----------------------------------------------------------------------------------------#
# Mandando Menssagem pro Terceiro Grupo
